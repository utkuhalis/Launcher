...
Class PanelBox
    ...
    Overrides Sub PaintHook()
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(249, 249, 249)), New Rectangle(1, 0, Width, Height))
        G.DrawRectangle(New Pen(Color.FromArgb(214, 214, 214)), 0, 0, Width, Height)
    End Sub
End Class
Class GroupDropBox
    Inherits ThemeContainerControl
