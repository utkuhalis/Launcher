...
Public Class UbuntuTestControl : Inherits Control

    Dim bgr As New Rectangle(0, 0, 200, 25)
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim bg0 As New LinearGradientBrush(bgr, Color.FromArgb(100, 0, 0, 0), Color.FromArgb(100, 0, 0, 0), 90S)
...
#Region " MouseStates "
    ...
    Dim bgr As New Rectangle(43, 2, 17, 17)

    Protected Overrides Sub OnMouseDown(ByVal e As System.Windows.Forms.MouseEventArgs)
        MyBase.OnMouseDown(e)
        If X > 43 AndAlso X < 60 Then
            FindForm.Close()
        End If
